    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-400">
      ...
      <div className="flex flex-col md:flex-row max-xs:h-screen md:w-full max-w-5xl m-0 xs:m-[6%] sm:m-[10%] md:m-[5%] bg-white rounded-lg shadow-md border border-black/20 md:overflow-hidden">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          <form onSubmit={handleSubmit} className="px-6 py-6 md:px-12 md:py-10">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-orange-300  rounded-lg mb-3 focus:outline-none focus:ring-2 focus:ring-orange-400  bg-[#f5e7e0]"
            />
            {/* Password */}
            <label
